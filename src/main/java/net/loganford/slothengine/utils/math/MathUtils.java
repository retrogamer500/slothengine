package net.loganford.slothengine.utils.math;
...
public class MathUtils {
    public static final float DEGREES_0 = 0;
    public static final float DEGREES_90 = 1 * ((float) Math.PI / 2);
    public static final float DEGREES_180 = 2 * ((float) Math.PI / 2);
    public static final float DEGREES_270 = 3 * ((float) Math.PI / 2);
